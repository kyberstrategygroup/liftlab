    ...
    <footer className="bg-black text-white">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 sm:gap-8">
            ...
            <div>
              <Link to={createPageUrl('Home')} className="flex items-center gap-3 mb-6">
                ...
                />
                <span className="text-base sm:text-lg font-black uppercase tracking-tight klavika-logo">
            ...
            <div>
              ...
              <ul className="space-y-2 sm:space-y-3">
                {[
                  ...
                  { name: 'Book a Session', page: 'StartNow' },
            ...
            {/* Contact */}
            <div>
              <h4 className="font-bold uppercase tracking-wider text-xs sm:text-sm mb-3 sm:mb-4">Contact</h4>
              <ul className="space-y-2 sm:space-y-3">
                <li>
                  <a 
                    href="mailto:contact@liftlab.ca"
                    className="flex items-center gap-2 text-zinc-400 hover:text-white transition-colors text-xs sm:text-sm"
                  >
            ...
            <div className="col-span-2 md:col-span-1">
              <h4 className="font-bold uppercase tracking-wider text-xs sm:text-sm mb-3 sm:mb-4">Follow</h4>
              <div className="flex gap-3 sm:gap-4">
                <a
                  href="https://www.facebook.com/ygkliftlab"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-9 h-9 sm:w-10 sm:h-10 bg-zinc-900 hover:bg-blue-600 flex items-center justify-center transition-colors"
                >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-9 h-9 sm:w-10 sm:h-10 bg-zinc-900 hover:bg-red-600 flex items-center justify-center transition-colors"
                >
      ...
      <div className="border-t border-zinc-800">
        <div className="container mx-auto px-4 sm:px-6 py-4 sm:py-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-3 sm:gap-4 text-[10px] sm:text-xs text-zinc-500">
