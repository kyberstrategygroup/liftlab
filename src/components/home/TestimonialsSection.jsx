      ...
      <div className="container mx-auto px-12">
        ...
        <div className="relative max-w-4xl mx-auto">
          ...
          <button
            ...
            className="absolute left-0 top-1/2 -translate-y-1/2 -translate-x-16 md:-translate-x-12 w-12 h-12 bg-black border-2 border-black hover:bg-blue-600 hover:text-white transition-all duration-300 flex items-center justify-center group"
          ...
          <button
            ...
            className="absolute right-0 top-1/2 -translate-y-1/2 translate-x-16 md:translate-x-12 w-12 h-12 bg-black border-2 border-black hover:bg-blue-600 hover:text-white transition-all duration-300 flex items-center justify-center group"
