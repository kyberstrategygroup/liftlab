              ...
              >
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <Button
                    ...
                    className="w-full h-14 bg-blue-600 hover:bg-blue-500 text-white font-bold uppercase tracking-wider text-sm lg:text-base transition-all duration-300 hover:shadow-lg hover:shadow-blue-600/25"
                  >
                    {isSubmitting ? (
